...
<section id="shop">
    <div class="container p-5">
        <h3 class="title">WELCOME {{ session()->get('name') ?? '' }} TO U-CANTEEN</h3>
                    ...
                    <div class="card mb-3 mt-5 p-4" style="max-width: 540px;">
                        <div class="row g-0 align-items-center">
                            <div class="col col-md-5">
                                <img src="/storage/{{ $get->img }}" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col col-md-7">
                                <div class="card-body text-center">
                                    <h1 class="card-title text-white">TOKO</h1>
                                    <center>
                                        <form action="/{{ strtolower($get->name) }}/menu" method="post">
                                            @csrf
                                            <button type="submit">
